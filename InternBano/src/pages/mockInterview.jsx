...
function MockInterview() {
    return (
        <div className="pt-16 bg-slate-50 dark:bg-slate-900 min-h-screen flex flex-col justify-between transition-colors duration-300">
            <div>
                <Navbar />
                
                <div className="container px-4 2xl:px-20 mx-auto my-12">
                    {/* Hero Showcase Section */}
                    <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 dark:from-blue-800 dark:via-blue-900 dark:to-50% text-white rounded-3xl p-8 md:p-16 shadow-2xl">
                        ...
                        <div className="relative z-10 max-w-3xl flex flex-col items-start">
                            ...
                            <a 
                                ...
                                className="bg-white dark:bg-slate-800 text-blue-700 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-700 font-bold px-8 py-4 rounded-2xl shadow-lg dark:shadow-indigo-900/30 transform hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 inline-flex items-center gap-3 text-lg group"
                            >
                    ...
                    <div className="my-16">
                        ...
                        <p className="text-gray-500 dark:text-slate-400 text-center text-lg max-w-2xl mx-auto mb-12">
                            Our advanced AI companion replicates actual interview settings to help you land your job with high confidence.
                        </p>
                        
                        <div className="grid md:grid-cols-3 gap-8">
                            {/* Feature 1 */}
                            <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-md border border-gray-100 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center mb-6">
                                    <svg className="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                    </svg>
                                </div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Role-Specific Questions</h3>
                            ...
                            <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-md border border-gray-100 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Immersive Practice</h3>
                                <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
                            ...
                            <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-md border border-gray-100 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Instant AI Feedback</h3>
                                <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
