...
function Hero() {
    ...
    return (
        <div className='container 2xl:px-20 my-10 mx-auto p-5'>
            <div className='bg-gradient-to-r from-blue-400 to-blue-200 p-5 rounded flex flex-col gap-5 max-sm:flex-col max-sm:items-center'>
                ...
                <div className='bg-white text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto rounded flex gap-3 items-center justify-between max-sm:flex-col max-sm:items-center w-full'>
                    ...
                    <button onClick={onSearch} className='bg-blue-400 px-6 py-2 rounded text-white m-1'>Search</button>
                </div>
            </div>

            <div className='my-10 border border-gray-300 bg-gray-200 shadow-md flex flex-col items-center  gap-5 max-sm:items-center'>
                <h2 className='text-2xl'>Top Companies</h2>
