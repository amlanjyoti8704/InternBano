...
function Navbar() {
    ...
    return (
        <div className='w-full h-16 bg-blue-600/20 dark:bg-gradient-to-r dark:from-slate-950 dark:to-[#383a49d6] flex items-center justify-center text-black font-bold text-xl'>
            <div className='ml-8'>
